...
import { BenchmarkEngine, StartBenchmarkConfig } from "./docker/BenchmarkEngine";
...
const App: React.FC = () => {
        ...
        let startBenchmark = function(startBenchmark: StartBenchmarkConfig) {
                if ("specific_node" === startBenchmark.environment_type) {
                        console.log("Use specific node");
                        console.log(startBenchmark.specific_target_port);
                        console.log(startBenchmark.specific_target_url);
                }
                console.log("Start benchmark: " + benchmarkId + " with name: " + startBenchmark.benchmark_name);
                let bc: BenchmarkEngine = new BenchmarkEngine(startBenchmark);
                let b: any;
